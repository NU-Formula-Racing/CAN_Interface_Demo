 ...
 *
 */
CANSignal<uint16_t, 0, 16, CANTemplateConvertFloat(1), CANTemplateConvertFloat(0), false> engine_rpm_signal{};
CANSignal<float, 16, 16, CANTemplateConvertFloat(0.1), CANTemplateConvertFloat(0), false> inlet_manifold_pressure_signal{};
CANSignal<float, 32, 16, CANTemplateConvertFloat(0.1), CANTemplateConvertFloat(0), true> inlet_manifold_temperature_signal{};
CANSignal<float, 48, 16, CANTemplateConvertFloat(0.1), CANTemplateConvertFloat(0), false> throttle_position_signal{};
 ...
 *
 */
CANRXMessage<4> rx_message{can_bus, 0x640, engine_rpm_signal, 
...
void loop()
{
   ...
   *
   */
  engine_rpm_signal = 0.0f;
  inlet_manifold_pressure_signal = 0.0f;
  inlet_manifold_temperature_signal = 0.0f;
  throttle_position_signal = 0.0f;
  // float_tx_signal = 5.195f;
  // uint8_t_tx_signal = 132;
  // bool_tx_signal = true;
  // millis_tx_signal = millis();

  uint16_t local_engine_rpm_signal = engine_rpm_signal;
  float local_inlet_manifold_pressure_signal = inlet_manifold_pressure_signal;
  float local_inlet_manifold_temperature_signal = inlet_manifold_temperature_signal;
  float local_throttle_position_signal = throttle_position_signal;
  ...
  /*
    ...
    Serial.println(float(local_throttle_position_signal));
